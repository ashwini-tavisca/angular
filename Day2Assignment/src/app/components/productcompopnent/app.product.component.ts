...
export class ProductComponent implements OnInit {
  ...
  reverseProductList() : void {
    this.products.reverse()
  }
  searchProduct(productName : string) : void {
    this.searchedProduct = this.products.filter(product => (product.ProductName == productName))
    console.log("Search list : " + this.searchedProduct)
  }
}
